...
addMixedArgsFromVaList(va_list argVaList) {
    double argSum = va_arg(argVaList,
 ...
 */
double
addDoublesFromVaListByUpcallMH(int argCount, va_list doubleVaList,
                               double (*upcallMH)(int, va_list)) {
    double arg1 = va_arg(doubleVaList,
                         double);
 ...
 */
double
addDoublesByPtrFromVaListByUpcallMH(int argCount, va_list ptrVaList,
                                    double (*upcallMH)(int, va_list)) {
 ...
 */
char
add1ByteOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                      char (*upcallMH)(int, va_list)) {
 ...
 */
char
add2BytesOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                       char (*upcallMH)(int, va_list)) {
    char byteSum = (*upcallMH)(argCount, struVaList);
    return byteSum;
}
 ...
 */
char
add3BytesOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                       char (*upcallMH)(int, va_list)) {
    char byteSum = (*upcallMH)(argCount, struVaList);
    return byteSum;
}
 ...
 */
char
add5BytesOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                       char (*upcallMH)(int, va_list)) {
    char byteSum = (*upcallMH)(argCount, struVaList);
    return byteSum;
}
 ...
 */
char
add7BytesOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                       char (*upcallMH)(int, va_list)) {
    char byteSum = (*upcallMH)(argCount, struVaList);
    return byteSum;
}
 ...
 */
short
add1ShortOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                       short (*upcallMH)(int, va_list)) {
 ...
 */
short
add2ShortsOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                        short (*upcallMH)(int, va_list)) {
    short shortSum = (*upcallMH)(argCount, struVaList);
    return shortSum;
}
 ...
 */
short
add3ShortsOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                        short (*upcallMH)(int, va_list)) {
    short shortSum = (*upcallMH)(argCount, struVaList);
    return shortSum;
}
 ...
 */
int
add1IntOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                     int (*upcallMH)(int, va_list)) {
 ...
 */
int
add2IntsOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                      int (*upcallMH)(int, va_list)) {
    int intSum = (*upcallMH)(argCount, struVaList);
    return intSum;
}
 ...
 */
int
add3IntsOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                      int (*upcallMH)(int, va_list)) {
    int intSum = (*upcallMH)(argCount, struVaList);
    return intSum;
}
 ...
 */
LONG
add2LongsOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                       LONG (*upcallMH)(int, va_list)) {
 ...
 */
float
add1FloatOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                       float (*upcallMH)(int, va_list)) {
 ...
 */
float
add2FloatsOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                        float (*upcallMH)(int, va_list)) {
    float floatSum = (*upcallMH)(argCount, struVaList);
    return floatSum;
}
 ...
 */
float
add3FloatsOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                        float (*upcallMH)(int, va_list)) {
    float floatSum = (*upcallMH)(argCount, struVaList);
    return floatSum;
}
 ...
 */
double
add1DoubleOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                        double (*upcallMH)(int, va_list)) {
 ...
 */
double
add2DoublesOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                         double (*upcallMH)(int, va_list)) {
    double doubleSum = (*upcallMH)(argCount, struVaList);
    return doubleSum;
}
 ...
 */
int
addIntShortOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                         int (*upcallMH)(int, va_list)) {
    int intSum = (*upcallMH)(argCount, struVaList);
    return intSum;
}
 ...
 */
int
addShortIntOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                         int (*upcallMH)(int, va_list)) {
    int intSum = (*upcallMH)(argCount, struVaList);
    return intSum;
}
 ...
 */
LONG
addIntLongOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                        LONG (*upcallMH)(int, va_list)) {
    LONG longSum = (*upcallMH)(argCount, struVaList);
    return longSum;
}
 ...
 */
LONG
addLongIntOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                        LONG (*upcallMH)(int, va_list)) {
    LONG longSum = (*upcallMH)(argCount, struVaList);
    return longSum;
}
 ...
 */
double
addFloatDoubleOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                            double (*upcallMH)(int, va_list)) {
    double doubleSum = (*upcallMH)(argCount, struVaList);
    return doubleSum;
}
 ...
 */
double
addDoubleFloatOfStructsFromVaListByUpcallMH(int argCount, va_list struVaList,
                                            double (*upcallMH)(int, va_list)) {
    double doubleSum = (*upcallMH)(argCount, struVaList);
    return doubleSum;
}
