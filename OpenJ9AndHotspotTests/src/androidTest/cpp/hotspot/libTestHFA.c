...
EXPORT struct S_FF add_float_to_struct_after_structs(
        struct S_FF s1, struct S_FF s2, struct S_FF s3, struct S_FF s4, struct S_FF s5,
        struct S_FF s6,
...
// Upcall versions.
EXPORT struct S_FFFFFFF
pass_two_large_structs(struct S_FFFFFFF (*fun)(struct S_FFFFFFF, struct S_FFFFFFF),
