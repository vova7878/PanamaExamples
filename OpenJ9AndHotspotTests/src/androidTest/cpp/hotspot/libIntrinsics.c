...
EXPORT double
invoke_high_arity1(int x, double d, long long l, float f, char c, short s1, short s2) {
    return d;
}

EXPORT long long
invoke_high_arity2(int x, double d, long long l, float f, char c, short s1, short s2) {
    return l;
}
