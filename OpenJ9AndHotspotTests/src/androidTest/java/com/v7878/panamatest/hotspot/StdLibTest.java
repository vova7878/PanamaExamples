...
public class StdLibTest extends NativeTestHelper {
    ...
    @Test
    @UseDataProvider("stringPairs")
    public void test_strcat(String s1, String s2) throws Throwable {
        assertEquals(stdLibHelper.strcat(s1, s2), s1 + s2);
    }

    @Test
    @UseDataProvider("stringPairs")
    public void test_strcmp(String s1, String s2) throws Throwable {
        assertEquals(Integer.signum(stdLibHelper.strcmp(s1, s2)), Integer.signum(s1.compareTo(s2)));
    }

    @Test
    @UseDataProvider("strings")
    public void test_puts(String s) throws Throwable {
        assertTrue(stdLibHelper.puts(s) >= 0);
    }

    @Test
    @UseDataProvider("strings")
    public void test_strlen(String s) throws Throwable {
        assertEquals(stdLibHelper.strlen(s), s.length());
    }

    @Test
    @UseDataProvider("instants")
    public void test_time(Instant instant) throws Throwable {
    ...
    @Test
    @UseDataProvider("ints")
    public void test_qsort(List<Integer> ints) throws Throwable {
        if (ints.size() > 0) {
    ...
    @Test
    public void test_rand() throws Throwable {
    ...
    @Test
    @UseDataProvider("printfArgs")
    public void test_printf(List<PrintfArg> args) throws Throwable {
    ...
    @Test
    public void testSystemLibraryBadLookupName() {
