...
import com.v7878.panamatest.hotspot.CallGeneratorHelper;
...
public class TestVarArgs extends CallGeneratorHelper {
    ...
    void testVarArgs(int count, String fName, Ret ret, // ignore this stuff
                     List<ParamType> paramTypes, List<StructFieldType> fields) throws Throwable {
        {
            // TODO: fix for x86_64
            String arch = System.getProperty("os.arch");
            assumeFalse(arch != null && (arch.equals("amd64") || arch.equals("x86_64")));
        }
        try (Arena arena = Arena.ofConfined()) {
            ...
            FunctionDescriptor baseDesc = FunctionDescriptor.ofVoid(argLayouts.toArray(new MemoryLayout[0]));
    ...
    static Object[][] variadicFunctions() {
