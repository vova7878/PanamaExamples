...
public class TestHFA {
    ...
    public void testAddFloatToStructAfterFloats() {
        ...
        if (p0 != 2.0f || p1 != 1.0f)
            throw new RuntimeException("add_float_to_struct_after_floats error");
    }
    ...
    public void testAddFloatToStructAfterStructs() {
        ...
        if (p0 != 2.0f || p1 != 1.0f)
            throw new RuntimeException("add_float_to_struct_after_structs error");
    }
    ...
    public void testAddDoubleToStructAfterStructs() {
        ...
        if (p0 != 2.0f || p1 != 1.0f)
            throw new RuntimeException("add_double_to_struct_after_structs error");
    }
    ...
    public void testAddFloatToStructAfterFloatsUpcall() {
        ...
        if (p0 != 2.0f || p1 != 1.0f)
            throw new RuntimeException("add_float_to_struct_after_floats (Upcall)");
    }
    ...
    public void testAddFloatToStructAfterStructsUpcall() {
        ...
        if (p0 != 2.0f || p1 != 1.0f)
            throw new RuntimeException("add_float_to_struct_after_structs (Upcall)");
    }
    ...
    public void testAddDoubleToStructAfterStructsUpcall() {
        ...
        if (p0 != 2.0f || p1 != 1.0f)
            throw new RuntimeException("add_double_to_struct_after_structs (Upcall)");
    }
