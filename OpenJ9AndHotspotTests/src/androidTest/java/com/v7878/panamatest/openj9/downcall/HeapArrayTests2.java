...
import com.v7878.panamatest.openj9.Shared;
...
public class HeapArrayTests2 {
    ...
    public void test_addLongFromStructPtrsWithOffset_2() throws Throwable {
        FunctionDescriptor fd = FunctionDescriptor.of(Shared.C_LONG_LONG, Shared.C_LONG_LONG, ADDRESS);
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            long result = (long) mh.invoke(functionSymbol, 224466880022L, structSegmt.asSlice(Shared.C_LONG_LONG.byteSize()));
    ...
    public void test_addDoubleFromStructPtrsWithOffset_2() throws Throwable {
        FunctionDescriptor fd = FunctionDescriptor.of(Shared.C_DOUBLE, Shared.C_DOUBLE, ADDRESS);
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            double result = (double) mh.invoke(functionSymbol, 66.776D, structSegmt.asSlice(Shared.C_DOUBLE.byteSize()));
    ...
    public void test_addLongFromArrayPtrByOne_discontiguousArrays_2() throws Throwable {
        SequenceLayout arrayLayout = MemoryLayout.sequenceLayout(arrayLength, Shared.C_LONG_LONG);
        FunctionDescriptor fd = FunctionDescriptor.ofVoid(JAVA_INT, ADDRESS, ADDRESS);
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            MemorySegment nativeSegmt = arena.allocate(arrayLayout);
            for (int index = 0; index < arrayLength; index++) {
                nativeSegmt.setAtIndex(Shared.C_LONG_LONG, index, 10000000000L);
                heapSegmt.setAtIndex(Shared.C_LONG_LONG, index, nativeSegmt.getAtIndex(Shared.C_LONG_LONG, index));
            }

            mh.invoke(functionSymbol, arrayLength, heapSegmt, nativeSegmt);
            for (int index = 0; index < arrayLength; index++) {
                Assert.assertEquals(heapSegmt.getAtIndex(Shared.C_LONG_LONG, index), nativeSegmt.getAtIndex(Shared.C_LONG_LONG, index) + 1);
            }
        }
    }
    ...
    public void test_addDoubleFromArrayPtrByOne_discontiguousArrays_2() throws Throwable {
        SequenceLayout arrayLayout = MemoryLayout.sequenceLayout(arrayLength, Shared.C_DOUBLE);
        FunctionDescriptor fd = FunctionDescriptor.ofVoid(JAVA_INT, ADDRESS, ADDRESS);
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            MemorySegment nativeSegmt = arena.allocate(arrayLayout);
            for (int index = 0; index < arrayLength; index++) {
                nativeSegmt.setAtIndex(Shared.C_DOUBLE, index, 1234567890.345D);
                heapSegmt.setAtIndex(Shared.C_DOUBLE, index, nativeSegmt.getAtIndex(Shared.C_DOUBLE, index));
            }

            mh.invoke(functionSymbol, arrayLength, heapSegmt, nativeSegmt);
            for (int index = 0; index < arrayLength; index++) {
                Assert.assertEquals(heapSegmt.getAtIndex(Shared.C_DOUBLE, index), nativeSegmt.getAtIndex(Shared.C_DOUBLE, index) + 1, 0.001D);
            }
        }
    }
}
