...
public class StructTests1 {
    ...
    public void test_addLongAndLongsFromStruct_1() throws Throwable {
        ...
        FunctionDescriptor fd = FunctionDescriptor.of(C_LONG_LONG, C_LONG_LONG, structLayout);
    ...
    public void test_addIntAndIntLongFromStruct_1() throws Throwable {
        GroupLayout structLayout = IS_LONG_SMALL_ALIGNMENT ? MemoryLayout.structLayout(JAVA_INT.withName("elem1"),
                C_LONG_LONG.withName("elem2")) : MemoryLayout.structLayout(JAVA_INT.withName("elem1"),
                MemoryLayout.paddingLayout(JAVA_INT.byteSize()), C_LONG_LONG.withName("elem2"));
        VarHandle elemHandle1 = structLayout.varHandle(PathElement.groupElement("elem1"));
        VarHandle elemHandle2 = structLayout.varHandle(PathElement.groupElement("elem2"));

        FunctionDescriptor fd = FunctionDescriptor.of(C_LONG_LONG, JAVA_INT, structLayout);
    ...
    public void test_addIntAndLongIntFromStruct_1() throws Throwable {
        GroupLayout structLayout = IS_LONG_SMALL_ALIGNMENT ? MemoryLayout.structLayout(C_LONG_LONG.withName("elem1"),
                JAVA_INT.withName("elem2")) : MemoryLayout.structLayout(C_LONG_LONG.withName("elem1"),
    ...
    public void test_addLongFromPointerAndLongsFromStruct_1() throws Throwable {
        ...
        FunctionDescriptor fd = FunctionDescriptor.of(C_LONG_LONG, ADDRESS, structLayout);
        MemorySegment functionSymbol = nativeLibLookup.find("addLongFromPointerAndLongsFromStruct").get();
        MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

        try (Arena arena = Arena.ofConfined()) {
            MemorySegment longSegmt = arena.allocateFrom(C_LONG_LONG, 1111111111L);
            MemorySegment structSegmt = arena.allocate(structLayout);
    ...
    public void test_addLongFromPointerAndLongsFromStruct_returnLongPointer_1() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment longSegmt = arena.allocateFrom(C_LONG_LONG, 1122334455L);
            MemorySegment structSegmt = arena.allocate(structLayout);
            ...
            MemorySegment resultSegmt = resultAddr.reinterpret(C_LONG_LONG.byteSize());
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 0), 9034792245L);
    ...
    public void test_addLongAndLongsFromStructPointer_1() throws Throwable {
        ...
        FunctionDescriptor fd = FunctionDescriptor.of(C_LONG_LONG, C_LONG_LONG, ADDRESS);
    ...
    public void test_addLongAndLongsFromNestedStruct_1() throws Throwable {
        ...
        GroupLayout structLayout = MemoryLayout.structLayout(C_LONG_LONG.withName("elem1"), nestedStructLayout.withName("struct_elem2"));
        FunctionDescriptor fd = FunctionDescriptor.of(C_LONG_LONG, C_LONG_LONG, structLayout);
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment structSegmt = arena.allocate(structLayout);
            structSegmt.set(C_LONG_LONG, 0, 135791357913L);
            structSegmt.set(C_LONG_LONG, 8, 246802468024L);
            structSegmt.set(C_LONG_LONG, 16, 112233445566L);
    ...
    public void test_addLongAndLongsFromNestedStruct_withoutLayoutName_1() throws Throwable {
        GroupLayout nestedStructLayout = MemoryLayout.structLayout(C_LONG_LONG, C_LONG_LONG);
        GroupLayout structLayout = MemoryLayout.structLayout(C_LONG_LONG, nestedStructLayout);
        FunctionDescriptor fd = FunctionDescriptor.of(C_LONG_LONG, C_LONG_LONG, structLayout);
        MemorySegment functionSymbol = nativeLibLookup.find("addLongAndLongsFromNestedStruct").get();
        MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
    ...
    public void test_addLongAndLongsFromStructWithNestedLongArray_1() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment structSegmt = arena.allocate(structLayout);
            structSegmt.set(C_LONG_LONG, 0, 111111111L);
            structSegmt.set(C_LONG_LONG, 8, 222222222L);
            structSegmt.set(C_LONG_LONG, 16, 333333333L);
    ...
    public void test_addLongAndLongsFromStructWithNestedLongArray_reverseOrder_1() throws Throwable {
        SequenceLayout longArray = MemoryLayout.sequenceLayout(2, C_LONG_LONG);
        GroupLayout structLayout = MemoryLayout.structLayout(C_LONG_LONG.withName("elem1"), longArray.withName("array_elem2"));
        FunctionDescriptor fd = FunctionDescriptor.of(C_LONG_LONG, C_LONG_LONG, structLayout);
    ...
    public void test_addLongAndLongsFromStructWithNestedLongArray_withoutLayoutName_1() throws Throwable {
        SequenceLayout longArray = MemoryLayout.sequenceLayout(2, C_LONG_LONG);
        GroupLayout structLayout = MemoryLayout.structLayout(longArray, C_LONG_LONG);
        FunctionDescriptor fd = FunctionDescriptor.of(C_LONG_LONG, C_LONG_LONG, structLayout);
        MemorySegment functionSymbol = nativeLibLookup.find("addLongAndLongsFromStructWithNestedLongArray").get();
        MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
    ...
    public void test_addLongAndLongsFromStructWithNestedStructArray_1() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            structSegmt.set(C_LONG_LONG, 8, 222222222L);
            structSegmt.set(C_LONG_LONG, 16, 333333333L);
            structSegmt.set(C_LONG_LONG, 24, 444444444L);
            structSegmt.set(C_LONG_LONG, 32, 555555555L);
    ...
    public void test_addLongAndLongsFromStructWithNestedStructArray_reverseOrder_1() throws Throwable {
        GroupLayout longStruct = MemoryLayout.structLayout(C_LONG_LONG.withName("elem1"), C_LONG_LONG.withName("elem2"));
        SequenceLayout structArray = MemoryLayout.sequenceLayout(2, longStruct);
        GroupLayout structLayout = MemoryLayout.structLayout(C_LONG_LONG.withName("elem1"), structArray.withName("struct_array_elem2"));
        FunctionDescriptor fd = FunctionDescriptor.of(C_LONG_LONG, C_LONG_LONG, structLayout);
    ...
    public void test_addLongAndLongsFromStructWithNestedStructArray_withoutLayoutName_1() throws Throwable {
        GroupLayout longStruct = MemoryLayout.structLayout(C_LONG_LONG, C_LONG_LONG);
        SequenceLayout structArray = MemoryLayout.sequenceLayout(2, longStruct);
        GroupLayout structLayout = MemoryLayout.structLayout(structArray, C_LONG_LONG);
        FunctionDescriptor fd = FunctionDescriptor.of(C_LONG_LONG, C_LONG_LONG, structLayout);
        MemorySegment functionSymbol = nativeLibLookup.find("addLongAndLongsFromStructWithNestedStructArray").get();
        MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
    ...
    public void test_add2LongStructs_returnStructPointer_1() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            MemorySegment resultAddr = (MemorySegment) mh.invoke(structSegmt1, structSegmt2);
            MemorySegment resultSegmt = resultAddr.reinterpret(structLayout.byteSize());
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 0), 11022446688L);
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 8), 8911335576L);
        }
    }
    ...
    public void test_addDoubleAndFloatDoubleFromStruct_1() throws Throwable {
         ...
         */
        GroupLayout structLayout = IS_DOUBLE_SMALL_ALIGNMENT ? MemoryLayout.structLayout(JAVA_FLOAT.withName("elem1"),
                C_DOUBLE.withName("elem2")) : MemoryLayout.structLayout(JAVA_FLOAT.withName("elem1"),
                MemoryLayout.paddingLayout(JAVA_FLOAT.byteSize()), C_DOUBLE.withName("elem2"));
        VarHandle elemHandle1 = structLayout.varHandle(PathElement.groupElement("elem1"));
        VarHandle elemHandle2 = structLayout.varHandle(PathElement.groupElement("elem2"));
    ...
    public void test_addDoubleAndIntDoubleFromStruct_1() throws Throwable {
         ...
         * while the same struct is 16 bytes with padding on other platforms.
         */
        GroupLayout structLayout = IS_DOUBLE_SMALL_ALIGNMENT ? MemoryLayout.structLayout(JAVA_INT.withName("elem1"),
                C_DOUBLE.withName("elem2")) : MemoryLayout.structLayout(JAVA_INT.withName("elem1"),
                MemoryLayout.paddingLayout(JAVA_INT.byteSize()), C_DOUBLE.withName("elem2"));
        VarHandle elemHandle1 = structLayout.varHandle(PathElement.groupElement("elem1"));
        VarHandle elemHandle2 = structLayout.varHandle(PathElement.groupElement("elem2"));
    ...
    public void test_addDoubleAndDoubleFloatFromStruct_1() throws Throwable {
        GroupLayout structLayout = IS_DOUBLE_SMALL_ALIGNMENT ? MemoryLayout.structLayout(C_DOUBLE.withName("elem1"),
                JAVA_FLOAT.withName("elem2")) : MemoryLayout.structLayout(C_DOUBLE.withName("elem1"),
    ...
    public void test_addDoubleAndDoubleIntFromStruct_1() throws Throwable {
        GroupLayout structLayout = IS_DOUBLE_SMALL_ALIGNMENT ? MemoryLayout.structLayout(C_DOUBLE.withName("elem1"),
                JAVA_INT.withName("elem2")) : MemoryLayout.structLayout(C_DOUBLE.withName("elem1"),
                JAVA_INT.withName("elem2"), MemoryLayout.paddingLayout(JAVA_INT.byteSize()));
        VarHandle elemHandle1 = structLayout.varHandle(PathElement.groupElement("elem1"));
        VarHandle elemHandle2 = structLayout.varHandle(PathElement.groupElement("elem2"));
    ...
    public void test_addDoubleFromPointerAndDoublesFromStruct_1() throws Throwable {
        ...
        FunctionDescriptor fd = FunctionDescriptor.of(C_DOUBLE, ADDRESS, structLayout);
        MemorySegment functionSymbol = nativeLibLookup.find("addDoubleFromPointerAndDoublesFromStruct").get();
        MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

        try (Arena arena = Arena.ofConfined()) {
            MemorySegment doubleSegmt = arena.allocateFrom(C_DOUBLE, 112.123D);
            MemorySegment structSegmt = arena.allocate(structLayout);
    ...
    public void test_addDoubleFromPointerAndDoublesFromStruct_returnDoublePointer_1() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment doubleSegmt = arena.allocateFrom(C_DOUBLE, 212.123D);
            MemorySegment structSegmt = arena.allocate(structLayout);
            ...
            MemorySegment resultSegmt = resultAddr.reinterpret(C_DOUBLE.byteSize());
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 0), 650.368D, 0.001D);
    ...
    public void test_addDoubleAndDoublesFromStructPointer_1() throws Throwable {
        ...
        FunctionDescriptor fd = FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, ADDRESS);
    ...
    public void test_addDoubleAndDoublesFromNestedStruct_1() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment structSegmt = arena.allocate(structLayout);
            structSegmt.set(C_DOUBLE, 0, 31.789D);
            structSegmt.set(C_DOUBLE, 8, 33.456D);
            structSegmt.set(C_DOUBLE, 16, 35.123D);
    ...
    public void test_addDoubleAndDoublesFromStructWithNestedDoubleArray_1() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment structSegmt = arena.allocate(structLayout);
            structSegmt.set(C_DOUBLE, 0, 111.111D);
            structSegmt.set(C_DOUBLE, 8, 222.222D);
            structSegmt.set(C_DOUBLE, 16, 333.333D);
    ...
    public void test_addDoubleAndDoublesFromStructWithNestedStructArray_1() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            structSegmt.set(C_DOUBLE, 8, 222.222D);
            structSegmt.set(C_DOUBLE, 16, 333.333D);
            structSegmt.set(C_DOUBLE, 24, 444.444D);
            structSegmt.set(C_DOUBLE, 32, 555.555D);
    ...
    public void test_add2DoubleStructs_returnStructPointer_1() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            MemorySegment resultAddr = (MemorySegment) mh.invoke(structSegmt1, structSegmt2);
            MemorySegment resultSegmt = resultAddr.reinterpret(structLayout.byteSize());
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 0), 44.666D, 0.001D);
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 8), 66.888D, 0.001D);
        }
    }
