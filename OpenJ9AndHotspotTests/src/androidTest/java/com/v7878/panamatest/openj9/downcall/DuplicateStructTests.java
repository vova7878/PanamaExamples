...
public class DuplicateStructTests {
    ...
    public void test_addNestedLongStructs_dupStruct() throws Throwable {
        ...
        GroupLayout structLayout = MemoryLayout.structLayout(nestedStructLayout.withName("struct_elem1"), C_LONG_LONG.withName("elem2"));
        FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout);
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment structSegmt1 = arena.allocate(structLayout);
            structSegmt1.set(C_LONG_LONG, 0, 1357913579L);
            structSegmt1.set(C_LONG_LONG, 8, 2468024680L);
            structSegmt1.set(C_LONG_LONG, 16, 1122334455L);
            MemorySegment structSegmt2 = arena.allocate(structLayout);
            structSegmt2.set(C_LONG_LONG, 0, 1111111111L);
            structSegmt2.set(C_LONG_LONG, 8, 2222222222L);
            structSegmt2.set(C_LONG_LONG, 16, 3333333333L);

            MemorySegment resultSegmt = (MemorySegment) mh.invokeExact((SegmentAllocator) arena, structSegmt1, structSegmt2);
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 0), 2469024690L);
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 8), 4690246902L);
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 16), 4455667788L);
        }
    }

    @Test
    public void test_addLongStruct1AndNestedLongStruct2_returnStruct1_dupStruct() throws Throwable {
        GroupLayout structLayout1 = MemoryLayout.structLayout(C_LONG_LONG.withName("elem1"), C_LONG_LONG.withName("elem2"));
        ...
        GroupLayout structLayout2 = MemoryLayout.structLayout(structLayout1.withName("struct_elem1"), C_LONG_LONG.withName("elem2"));
        FunctionDescriptor fd = FunctionDescriptor.of(structLayout1, structLayout1, structLayout2);
    ...
    public void test_addLongStruct1AndNestedLongStruct2_returnStruct2_dupStruct() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            MemorySegment resultSegmt = (MemorySegment) mh.invokeExact((SegmentAllocator) arena, structSegmt1, structSegmt2);
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 0), 988765433098L);
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 8), 125679011345L);
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 16), 126790122456L);
        }
    }
    ...
    public void test_addNestedLongArrayStructs_dupStruct() throws Throwable {
        ...
        GroupLayout structLayout = MemoryLayout.structLayout(longArray.withName("array_elem1"), C_LONG_LONG.withName("elem2"));
        FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout);
    ...
    public void test_addLongStruct1AndNestedLongArrayStruct2_returnStruct1_dupStruct() throws Throwable {
        ...
        SequenceLayout longArray = MemoryLayout.sequenceLayout(2, C_LONG_LONG);
        GroupLayout structLayout2 = MemoryLayout.structLayout(longArray.withName("array_elem1"), C_LONG_LONG.withName("elem2"));
        FunctionDescriptor fd = FunctionDescriptor.of(structLayout1, structLayout1, structLayout2);
    ...
    public void test_addNestedLongStructArrayStructs_dupStruct() throws Throwable {
        GroupLayout longStruct = MemoryLayout.structLayout(C_LONG_LONG.withName("elem1"), C_LONG_LONG.withName("elem2"));
        SequenceLayout structArray = MemoryLayout.sequenceLayout(2, longStruct);
        GroupLayout structLayout = MemoryLayout.structLayout(structArray.withName("struct_array_elem1"), C_LONG_LONG.withName("elem2"));
        FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout);
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment structSegmt1 = arena.allocate(structLayout);
            structSegmt1.set(C_LONG_LONG, 0, 111111111L);
            structSegmt1.set(C_LONG_LONG, 8, 222222222L);
            structSegmt1.set(C_LONG_LONG, 16, 333333333L);
            structSegmt1.set(C_LONG_LONG, 24, 244444444L);
            structSegmt1.set(C_LONG_LONG, 32, 155555555L);
            MemorySegment structSegmt2 = arena.allocate(structLayout);
            structSegmt2.set(C_LONG_LONG, 0, 111111111L);
            structSegmt2.set(C_LONG_LONG, 8, 222222222L);
            structSegmt2.set(C_LONG_LONG, 16, 333333333L);
            structSegmt2.set(C_LONG_LONG, 24, 144444444L);
            structSegmt2.set(C_LONG_LONG, 32, 255555555L);

            MemorySegment resultSegmt = (MemorySegment) mh.invokeExact((SegmentAllocator) arena, structSegmt1, structSegmt2);
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 0), 222222222L);
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 8), 444444444L);
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 16), 666666666L);
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 24), 388888888L);
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 32), 411111110L);
        }
    }
    ...
    public void test_addLongStruct1AndNestedLongStructArrayStruct2_returnStruct1_dupStruct() throws Throwable {
        ...
        SequenceLayout structArray = MemoryLayout.sequenceLayout(2, structLayout1);
        GroupLayout structLayout2 = MemoryLayout.structLayout(structArray.withName("struct_array_elem1"), C_LONG_LONG.withName("elem2"));
        FunctionDescriptor fd = FunctionDescriptor.of(structLayout1, structLayout1, structLayout2);
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            structSegmt2.set(C_LONG_LONG, 8, 222222222L);
            structSegmt2.set(C_LONG_LONG, 16, 333333333L);
            structSegmt2.set(C_LONG_LONG, 24, 444444444L);
            structSegmt2.set(C_LONG_LONG, 32, 155555555L);
    ...
    public void test_addLongStruct1AndNestedLongStructArrayStruct2_returnStruct2_dupStruct() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            MemorySegment resultSegmt = (MemorySegment) mh.invokeExact((SegmentAllocator) arena, structSegmt1, structSegmt2);
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 0), 987765433098L);
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 8), 123679011345L);
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 16), 987987655320L);
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 24), 123901233567L);
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 32), 123612344678L);
        }
    }
    ...
    public void test_addNestedDoubleStructs_dupStruct() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment structSegmt1 = arena.allocate(structLayout);
            structSegmt1.set(C_DOUBLE, 0, 31.789D);
            structSegmt1.set(C_DOUBLE, 8, 33.456D);
            structSegmt1.set(C_DOUBLE, 16, 35.123D);
            MemorySegment structSegmt2 = arena.allocate(structLayout);
            structSegmt2.set(C_DOUBLE, 0, 11.222D);
            structSegmt2.set(C_DOUBLE, 8, 22.333D);
            structSegmt2.set(C_DOUBLE, 16, 33.445D);

            MemorySegment resultSegmt = (MemorySegment) mh.invokeExact((SegmentAllocator) arena, structSegmt1, structSegmt2);
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 0), 43.011D, 0.001D);
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 8), 55.789D, 0.001D);
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 16), 68.568D, 0.001D);
        }
    }
    ...
    public void test_addDoubleStruct1AndNestedDoubleStruct2_returnStruct1_dupStruct() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            doubleHandle2.set(structSegmt1, 0L, 22.333D);
            MemorySegment structSegmt2 = arena.allocate(structLayout2);
            structSegmt2.set(C_DOUBLE, 0, 31.789D);
            structSegmt2.set(C_DOUBLE, 8, 33.456D);
            structSegmt2.set(C_DOUBLE, 16, 35.123D);
    ...
    public void test_addDoubleStruct1AndNestedDoubleStruct2_returnStruct2_dupStruct() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            structSegmt2.set(C_DOUBLE, 0, 31.789D);
            structSegmt2.set(C_DOUBLE, 8, 33.456D);
            structSegmt2.set(C_DOUBLE, 16, 35.124D);

            MemorySegment resultSegmt = (MemorySegment) mh.invokeExact((SegmentAllocator) arena, structSegmt1, structSegmt2);
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 0), 43.011D, 0.001D);
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 8), 55.789D, 0.001D);
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 16), 57.457D, 0.001D);
        }
    }
    ...
    public void test_addNestedDoubleStructArrayStructs_dupStruct() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment structSegmt1 = arena.allocate(structLayout);
            structSegmt1.set(C_DOUBLE, 0, 111.111D);
            structSegmt1.set(C_DOUBLE, 8, 222.222D);
            structSegmt1.set(C_DOUBLE, 16, 333.333D);
            structSegmt1.set(C_DOUBLE, 24, 444.444D);
            structSegmt1.set(C_DOUBLE, 32, 555.555D);
            MemorySegment structSegmt2 = arena.allocate(structLayout);
            structSegmt2.set(C_DOUBLE, 0, 519.117D);
            structSegmt2.set(C_DOUBLE, 8, 428.226D);
            structSegmt2.set(C_DOUBLE, 16, 336.335D);
            structSegmt2.set(C_DOUBLE, 24, 247.444D);
            structSegmt2.set(C_DOUBLE, 32, 155.553D);

            MemorySegment resultSegmt = (MemorySegment) mh.invokeExact((SegmentAllocator) arena, structSegmt1, structSegmt2);
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 0), 630.228D, 0.001D);
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 8), 650.448D, 0.001D);
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 16), 669.668D, 0.001D);
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 24), 691.888D, 0.001D);
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 32), 711.108D, 0.001D);
        }
    }
    ...
    public void test_addDoubleStruct1AndNestedDoubleStructArrayStruct2_returnStruct1_dupStruct() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            structSegmt2.set(C_DOUBLE, 0, 519.117D);
            structSegmt2.set(C_DOUBLE, 8, 428.226D);
            structSegmt2.set(C_DOUBLE, 16, 336.331D);
            structSegmt2.set(C_DOUBLE, 24, 247.444D);
            structSegmt2.set(C_DOUBLE, 32, 155.552D);
    ...
    public void test_addDoubleStruct1AndNestedDoubleStructArrayStruct2_returnStruct2_dupStruct() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            doubleHandle2.set(structSegmt1, 0L, 22.333D);
            MemorySegment structSegmt2 = arena.allocate(structLayout2);
            structSegmt2.set(C_DOUBLE, 0, 519.116D);
            structSegmt2.set(C_DOUBLE, 8, 428.225D);
            structSegmt2.set(C_DOUBLE, 16, 336.331D);
            structSegmt2.set(C_DOUBLE, 24, 247.444D);
            structSegmt2.set(C_DOUBLE, 32, 155.552D);

            MemorySegment resultSegmt = (MemorySegment) mh.invokeExact((SegmentAllocator) arena, structSegmt1, structSegmt2);
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 0), 530.338D, 0.001D);
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 8), 450.558D, 0.001D);
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 16), 347.553D, 0.001D);
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 24), 269.777D, 0.001D);
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 32), 177.885D, 0.001D);
        }
    }
}
