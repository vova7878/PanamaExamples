...
public class UpcallMHWithMixedSigStruTests {
    ...
    public void test_addIntAndIntLongFromStructByUpcallMH() throws Throwable {
        ...
        FunctionDescriptor fd = FunctionDescriptor.of(C_LONG_LONG, JAVA_INT, structLayout, ADDRESS);
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment upcallFuncAddr = linker.upcallStub(UpcallMethodHandles.MH_addIntAndIntLongFromStruct,
                    FunctionDescriptor.of(C_LONG_LONG, JAVA_INT, structLayout), arena);
            MemorySegment structSegmt = arena.allocate(structLayout);
            elemHandle1.set(structSegmt, 0L, 11223344);
    ...
    public void test_addDoubleAndFloatIntDoubleFromStructByUpcallMH() throws Throwable {
        GroupLayout structLayout = MemoryLayout.structLayout(JAVA_FLOAT.withName("elem1"),
                JAVA_INT.withName("elem2"), C_DOUBLE.withName("elem3"));
        VarHandle elemHandle1 = structLayout.varHandle(PathElement.groupElement("elem1"));
        VarHandle elemHandle2 = structLayout.varHandle(PathElement.groupElement("elem2"));
        VarHandle elemHandle3 = structLayout.varHandle(PathElement.groupElement("elem3"));
    ...
    public void test_addDoubleAndLongDoubleFromStructByUpcallMH() throws Throwable {
        GroupLayout structLayout = MemoryLayout.structLayout(C_LONG_LONG.withName("elem1"), C_DOUBLE.withName("elem2"));
        VarHandle elemHandle1 = structLayout.varHandle(PathElement.groupElement("elem1"));
        VarHandle elemHandle2 = structLayout.varHandle(PathElement.groupElement("elem2"));
    ...
    public void test_addLongAndLong2FloatsFromStructByUpcallMH() throws Throwable {
        GroupLayout structLayout = MemoryLayout.structLayout(C_LONG_LONG.withName("elem1"),
                JAVA_FLOAT.withName("elem2"), JAVA_FLOAT.withName("elem3"));
        VarHandle elemHandle1 = structLayout.varHandle(PathElement.groupElement("elem1"));
        VarHandle elemHandle2 = structLayout.varHandle(PathElement.groupElement("elem2"));
        VarHandle elemHandle3 = structLayout.varHandle(PathElement.groupElement("elem3"));
    ...
    public void test_addLongAndFloatLongFromStructByUpcallMH() throws Throwable {
        GroupLayout structLayout = IS_LONG_SMALL_ALIGNMENT ? MemoryLayout.structLayout(JAVA_FLOAT.withName("elem1"),
                C_LONG_LONG.withName("elem2")) : MemoryLayout.structLayout(JAVA_FLOAT.withName("elem1"),
                MemoryLayout.paddingLayout(JAVA_FLOAT.byteSize()), C_LONG_LONG.withName("elem2"));
        VarHandle elemHandle1 = structLayout.varHandle(PathElement.groupElement("elem1"));
        VarHandle elemHandle2 = structLayout.varHandle(PathElement.groupElement("elem2"));
    ...
    public void test_addDoubleAndDoubleLongFromStructByUpcallMH() throws Throwable {
        GroupLayout structLayout = MemoryLayout.structLayout(C_DOUBLE.withName("elem1"), C_LONG_LONG.withName("elem2"));
        VarHandle elemHandle1 = structLayout.varHandle(PathElement.groupElement("elem1"));
        VarHandle elemHandle2 = structLayout.varHandle(PathElement.groupElement("elem2"));
    ...
    public void test_addDoubleAndIntDoubleFloatFromStructByUpcallMH() throws Throwable {
        GroupLayout structLayout = IS_DOUBLE_SMALL_ALIGNMENT ? MemoryLayout.structLayout(JAVA_INT.withName("elem1"),
                ...
                C_DOUBLE.withName("elem2"), JAVA_FLOAT.withName("elem3"), MemoryLayout.paddingLayout(JAVA_FLOAT.byteSize()));
        VarHandle elemHandle1 = structLayout.varHandle(PathElement.groupElement("elem1"));
        VarHandle elemHandle2 = structLayout.varHandle(PathElement.groupElement("elem2"));
        VarHandle elemHandle3 = structLayout.varHandle(PathElement.groupElement("elem3"));
    ...
    public void test_addDoubleAndFloatDoubleIntFromStructByUpcallMH() throws Throwable {
         ...
         */
        GroupLayout structLayout = IS_DOUBLE_SMALL_ALIGNMENT ? MemoryLayout.structLayout(JAVA_FLOAT.withName("elem1"),
                C_DOUBLE.withName("elem2"), JAVA_INT.withName("elem3"))
                : MemoryLayout.structLayout(JAVA_FLOAT.withName("elem1"), MemoryLayout.paddingLayout(JAVA_FLOAT.byteSize()),
                C_DOUBLE.withName("elem2"), JAVA_INT.withName("elem3"), MemoryLayout.paddingLayout(JAVA_FLOAT.byteSize()));
        VarHandle elemHandle1 = structLayout.varHandle(PathElement.groupElement("elem1"));
        VarHandle elemHandle2 = structLayout.varHandle(PathElement.groupElement("elem2"));
        VarHandle elemHandle3 = structLayout.varHandle(PathElement.groupElement("elem3"));
    ...
    public void test_addDoubleAndIntDoubleIntFromStructByUpcallMH() throws Throwable {
        ...
        GroupLayout structLayout = IS_DOUBLE_SMALL_ALIGNMENT ? MemoryLayout.structLayout(JAVA_INT.withName("elem1"),
                C_DOUBLE.withName("elem2"), JAVA_INT.withName("elem3"))
                : MemoryLayout.structLayout(JAVA_INT.withName("elem1"), MemoryLayout.paddingLayout(JAVA_INT.byteSize()),
                C_DOUBLE.withName("elem2"), JAVA_INT.withName("elem3"), MemoryLayout.paddingLayout(JAVA_INT.byteSize()));
        VarHandle elemHandle1 = structLayout.varHandle(PathElement.groupElement("elem1"));
        VarHandle elemHandle2 = structLayout.varHandle(PathElement.groupElement("elem2"));
        VarHandle elemHandle3 = structLayout.varHandle(PathElement.groupElement("elem3"));
    ...
    public void test_addDoubleAndIntDoubleLongFromStructByUpcallMH() throws Throwable {
         ...
         */
        GroupLayout structLayout = IS_DOUBLE_SMALL_ALIGNMENT ? (IS_LONG_SMALL_ALIGNMENT ? (MemoryLayout.structLayout(JAVA_INT.withName("elem1"),
                C_DOUBLE.withName("elem2"), C_LONG_LONG.withName("elem3"))) : MemoryLayout.structLayout(JAVA_INT.withName("elem1"),
                C_DOUBLE.withName("elem2"), MemoryLayout.paddingLayout(JAVA_INT.byteSize()), C_LONG_LONG.withName("elem3")))
                : MemoryLayout.structLayout(JAVA_INT.withName("elem1"), MemoryLayout.paddingLayout(JAVA_INT.byteSize()),
