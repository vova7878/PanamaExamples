...
public class MultiUpcallMHTests {
    ...
    public void test_addLongAndLongFromPointerByUpcallMH_SameScope() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            MemorySegment longSegmt1 = arena.allocateFrom(C_LONG_LONG, 5742457424L);
            ...
            MemorySegment upcallFuncAddr2 = linker.upcallStub(UpcallMethodHandles.MH_addLongAndLongFromPointer,
                    FunctionDescriptor.of(C_LONG_LONG, ADDRESS, C_LONG_LONG), arena);
            MemorySegment longSegmt2 = arena.allocateFrom(C_LONG_LONG, 5742457424L);
            ...
            MemorySegment upcallFuncAddr3 = linker.upcallStub(UpcallMethodHandles.MH_addLongAndLongFromPointer,
                    FunctionDescriptor.of(C_LONG_LONG, ADDRESS, C_LONG_LONG), arena);
            MemorySegment longSegmt3 = arena.allocateFrom(C_LONG_LONG, 5742457424L);
    ...
    public void test_addDoubleAndDoubleFromPtr_RetPtr_ByUpcallMH_SameScope() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            MemorySegment doubleSegmt1 = arena.allocateFrom(C_DOUBLE, 1159.748D);
            MemorySegment resultAddr1 = (MemorySegment) mh.invoke(doubleSegmt1, 1262.795D, upcallFuncAddr1);
            MemorySegment resultSegmt1 = resultAddr1.reinterpret(C_DOUBLE.byteSize());
            Assert.assertEquals(resultSegmt1.get(C_DOUBLE, 0), 2422.543D, 0.001D);

            MemorySegment upcallFuncAddr2 = linker.upcallStub(UpcallMethodHandles.MH_addDoubleAndDoubleFromPtr_RetPtr,
                    FunctionDescriptor.of(ADDRESS, ADDRESS, C_DOUBLE), arena);
            MemorySegment doubleSegmt2 = arena.allocateFrom(C_DOUBLE, 1159.748D);
            MemorySegment resultAddr2 = (MemorySegment) mh.invoke(doubleSegmt2, 1262.795D, upcallFuncAddr2);
            MemorySegment resultSegmt2 = resultAddr2.reinterpret(C_DOUBLE.byteSize());
            Assert.assertEquals(resultSegmt2.get(C_DOUBLE, 0), 2422.543D, 0.001D);

            MemorySegment upcallFuncAddr3 = linker.upcallStub(UpcallMethodHandles.MH_addDoubleAndDoubleFromPtr_RetPtr,
                    FunctionDescriptor.of(ADDRESS, ADDRESS, C_DOUBLE), arena);
            MemorySegment doubleSegmt3 = arena.allocateFrom(C_DOUBLE, 1159.748D);
            MemorySegment resultAddr3 = (MemorySegment) mh.invoke(doubleSegmt3, 1262.795D, upcallFuncAddr3);
            MemorySegment resultSegmt3 = resultAddr3.reinterpret(C_DOUBLE.byteSize());
            Assert.assertEquals(resultSegmt3.get(C_DOUBLE, 0), 2422.543D, 0.001D);
        }
    }
