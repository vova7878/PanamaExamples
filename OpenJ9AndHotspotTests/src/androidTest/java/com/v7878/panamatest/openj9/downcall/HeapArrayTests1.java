...
public class HeapArrayTests1 {
    ...
    public void test_addLongFromStructPtrsWithOffset_1() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            long result = (long) mh.invoke(224466880022L, structSegmt.asSlice(Shared.C_LONG_LONG.byteSize()));
    ...
    public void test_addDoubleFromStructPtrsWithOffset_1() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            double result = (double) mh.invoke(66.776D, structSegmt.asSlice(Shared.C_DOUBLE.byteSize()));
