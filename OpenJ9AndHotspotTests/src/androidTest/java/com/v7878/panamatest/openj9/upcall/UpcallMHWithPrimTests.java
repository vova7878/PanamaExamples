...
public class UpcallMHWithPrimTests {
    ...
    public void test_addTwoLongsByUpcallMH() throws Throwable {
        FunctionDescriptor fd = FunctionDescriptor.of(C_LONG_LONG, C_LONG_LONG, C_LONG_LONG, ADDRESS);
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment upcallFuncAddr = linker.upcallStub(UpcallMethodHandles.MH_add2Longs,
                    FunctionDescriptor.of(C_LONG_LONG, C_LONG_LONG, C_LONG_LONG), arena);
    ...
    public void test_addLongAndLongFromPointerByUpcallMH() throws Throwable {
        FunctionDescriptor fd = FunctionDescriptor.of(C_LONG_LONG, ADDRESS, C_LONG_LONG, ADDRESS);
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment upcallFuncAddr = linker.upcallStub(UpcallMethodHandles.MH_addLongAndLongFromPointer,
                    FunctionDescriptor.of(C_LONG_LONG, ADDRESS, C_LONG_LONG), arena);
            MemorySegment longSegmt = arena.allocateFrom(C_LONG_LONG, 5742457424L);
    ...
    public void test_addLongAndLongFromPtr_RetPtr_ByUpcallMH() throws Throwable {
        FunctionDescriptor fd = FunctionDescriptor.of(ADDRESS, ADDRESS, C_LONG_LONG, ADDRESS);
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment upcallFuncAddr = linker.upcallStub(UpcallMethodHandles.MH_addLongAndLongFromPtr_RetPtr,
                    FunctionDescriptor.of(ADDRESS, ADDRESS, C_LONG_LONG), arena);
            MemorySegment longSegmt = arena.allocateFrom(C_LONG_LONG, 5742457424L);
            ...
            Assert.assertEquals(resultSegmt.get(C_LONG_LONG, 0), 12409155659L);
        }
    }
    ...
    public void test_add2DoublesByUpcallMH() throws Throwable {
        FunctionDescriptor fd = FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, C_DOUBLE, ADDRESS);
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment upcallFuncAddr = linker.upcallStub(UpcallMethodHandles.MH_add2Doubles,
                    FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, C_DOUBLE), arena);
    ...
    public void test_addDoubleAndDoubleFromPointerByUpcallMH() throws Throwable {
        FunctionDescriptor fd = FunctionDescriptor.of(C_DOUBLE, ADDRESS, C_DOUBLE, ADDRESS);
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment upcallFuncAddr = linker.upcallStub(UpcallMethodHandles.MH_addDoubleAndDoubleFromPointer,
                    FunctionDescriptor.of(C_DOUBLE, ADDRESS, C_DOUBLE), arena);
            MemorySegment doubleSegmt = arena.allocateFrom(C_DOUBLE, 1159.748D);
    ...
    public void test_addDoubleAndDoubleFromPtr_RetPtr_ByUpcallMH() throws Throwable {
        FunctionDescriptor fd = FunctionDescriptor.of(ADDRESS, ADDRESS, C_DOUBLE, ADDRESS);
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment upcallFuncAddr = linker.upcallStub(UpcallMethodHandles.MH_addDoubleAndDoubleFromPtr_RetPtr,
                    FunctionDescriptor.of(ADDRESS, ADDRESS, C_DOUBLE), arena);
            MemorySegment doubleSegmt = arena.allocateFrom(C_DOUBLE, 1159.748D);
            ...
            Assert.assertEquals(resultSegmt.get(C_DOUBLE, 0), 2422.543D, 0.001D);
        }
    }
