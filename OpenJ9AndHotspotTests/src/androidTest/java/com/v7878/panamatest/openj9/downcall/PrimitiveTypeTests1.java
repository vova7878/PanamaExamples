...
import static com.v7878.panamatest.openj9.Shared.C_SIZE_T;
...
public class PrimitiveTypeTests1 {
    ...
    public void test_addTwoLongs_1() throws Throwable {
        FunctionDescriptor fd = FunctionDescriptor.of(C_LONG_LONG, C_LONG_LONG, C_LONG_LONG);
    ...
    public void test_addLongAndLongFromPointer_1() throws Throwable {
        FunctionDescriptor fd = FunctionDescriptor.of(C_LONG_LONG, ADDRESS, C_LONG_LONG);
        MemorySegment functionSymbol = nativeLibLookup.find("addLongAndLongFromPointer").get();
        MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

        MemorySegment longSegmt = arena.allocateFrom(C_LONG_LONG, 57424L);
    ...
    public void test_addDoubleAndDoubleFromPointer_1() throws Throwable {
        FunctionDescriptor fd = FunctionDescriptor.of(C_DOUBLE, ADDRESS, C_DOUBLE);
        MemorySegment functionSymbol = nativeLibLookup.find("addDoubleAndDoubleFromPointer").get();
        MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

        MemorySegment doubleSegmt = arena.allocateFrom(C_DOUBLE, 159.748d);
    ...
    public void test_strlenFromDefaultLibWithMemAddr_1() throws Throwable {
        ...
        FunctionDescriptor fd = FunctionDescriptor.of(C_SIZE_T, ADDRESS);
    ...
    public void test_memoryAllocFreeFromDefaultLib_1() throws Throwable {
        ...
        FunctionDescriptor allocFuncDesc = FunctionDescriptor.of(ADDRESS, C_LONG_LONG);
